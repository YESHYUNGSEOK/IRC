...
int main(void) {
	...
	for (std::vector<std::string>::const_iterator it = msg1.get_params().begin(); it != msg1.get_params().end(); it++) {
	...
	for (std::vector<std::string>::const_iterator it = msg2.get_params().begin(); it != msg2.get_params().end(); it++) {
		std::cout << *it << std::endl;
	}
	std::cout << "======================" << std::endl;
	...
	for (std::vector<std::string>::const_iterator it = msg3.get_params().begin(); it != msg3.get_params().end(); it++) {
		std::cout << *it << std::endl;
	}
	std::cout << "======================" << std::endl;
}
