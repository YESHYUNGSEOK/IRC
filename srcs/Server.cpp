...
bool Server::check_channel_name(const std::vector<std::string> &channel_tokens) const
{
	for (std::vector<std::string>::const_iterator it = channel_tokens.begin(); it != channel_tokens.end(); it++)
	{
		// if (it->size() > 50)
		// 	return false;
