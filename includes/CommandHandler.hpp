...
public:
  ...
  static void invite(std::set<Channel *> channels, std::set<Client *> clients, Client *client, Message message); // param: user list, channel list
  static void kick(std::set<Channel *> channels, std::set<Client *> clients, Client *client, Message message);   // param: user
