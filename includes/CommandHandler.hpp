...
class CommandHandler {
 public:
  ...
  static void part(std::set<Channel *> channels, Client *client,
                   Message message);  // param: channel, user
  static void topic(std::set<Channel *> channels, Client *client,
                    Message message);  // param: channel list
  static void mode();                  // param: channel
  static void names();                 // param: user list
  static void list();                  // param: channel list
  static void invite(std::set<Channel *> channels, Client *client,
                     Message message);  // param: user list, channel list
  static void kick(std::set<Channel *> channels, Client *client,
                   Message message);  // param: user
